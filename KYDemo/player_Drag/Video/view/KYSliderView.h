...
@protocol KYSliderViewDelegate <NSObject>
...
@interface KYSliderButton : UIButton

@end

@interface KYSliderView : UIView

@property (nonatomic, weak) id<KYSliderViewDelegate> delegate;

/** 滑块 */
@property (nonatomic, strong, readonly) KYSliderButton *sliderBtn;
