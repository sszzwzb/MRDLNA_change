...
@interface KYPlayerControlView : UIView <ZFPlayerMediaControl>

/// 竖屏控制层的View
@property (nonatomic, strong, readonly) KYPortraitControlView *portraitControlView;

/// 横屏控制层的View
@property (nonatomic, strong, readonly) KYLandScapeControlView *landScapeControlView;
...
/// 快进快退进度progress
@property (nonatomic, strong, readonly) KYSliderView *fastProgressView;
...
/// 底部播放进度
@property (nonatomic, strong, readonly) KYSliderView *bottomPgrogress;
...
/// 最后播放时间s秒，默认 -1秒（不限制） kaiyi add  默认不传或传-1或0，传了的话就一直传
@property (nonatomic,assign) NSTimeInterval curLastVideoTime;
