...
/**
 投屏的进度条显示对应的时间 kaiyi
 */
- (void)upnpGetPositionInfoResponseTrackDuration:(CGFloat)trackDuration absTime:(CGFloat)absTime relTime:(CGFloat)relTime;
...
/**
 投屏结束
 */
- (void)dlnaEndPlayGetPositionInfoResponseTrackDuration:(CGFloat)trackDuration absTime:(CGFloat)absTime relTime:(CGFloat)relTime;
