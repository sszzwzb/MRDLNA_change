...
- (id)initWithTitle:(NSString *)title message:(NSString *)message cancelButtonTitle:(NSString *)cancelButtonTitle
{
    ...
    //messageLabel.textAlignment = NSTextAlignmentCenter;//update by kate
...
- (void)show
{
    ...
    if (!self.alertWindow) {
        ...
        //SubUIWindow *window = [[SubUIWindow alloc]initWithFrame:[UIScreen mainScreen].bounds];
...
- (void)updateBlurBackground
{
    ...
    // update by kate 2014.11.4 修正弹出框为白色
