...
#else
            CGRect a = self.attachedView.mm_dimBackgroundView.frame;
            CGRect b = self.frame;
            CGRect c = self.attachedView.frame;
            CGRect d = CGRectMake(0, 300, 320, 300);
            
            
            UIBlurEffect *effect = [UIBlurEffect effectWithStyle:UIBlurEffectStyleLight];
            UIVisualEffectView *effectView = [[UIVisualEffectView alloc] initWithEffect:effect];
            effectView.frame = d;
            [self.attachedView addSubview:effectView];
            
            UIVibrancyEffect *vibrancyEffect = [UIVibrancyEffect effectForBlurEffect:effect];
            UIVisualEffectView *vibrancyEffectView = [[UIVisualEffectView alloc] initWithEffect:vibrancyEffect];
            [vibrancyEffectView setFrame:d];
            
            [[vibrancyEffectView contentView] addSubview:self];
