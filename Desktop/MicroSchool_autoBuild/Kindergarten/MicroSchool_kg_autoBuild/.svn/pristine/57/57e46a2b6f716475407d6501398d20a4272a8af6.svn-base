    ...
    switch (_pageMode) {
        case JTCalendarPageModeFull:
            ...
            if(self.contentOffset.x < size.width / 2.){
                NSLog(@"resizeViewsIfWidthChanged 8888888888");
//                [[NSNotificationCenter defaultCenter] postNotificationName:@"preLoadCheckinData" object:nil];
        ...
        case JTCalendarPageModeCenterLeft:
            ...
            if(self.contentOffset.x < size.width / 2.){
                NSLog(@"resizeViewsIfWidthChanged 9999999");
//                [[NSNotificationCenter defaultCenter] postNotificationName:@"preLoadCheckinData" object:nil];
