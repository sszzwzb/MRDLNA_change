...
@interface SettingHomeViewController ()
...
//    
//    [settingPersonalInfo setObject:provincesStr forKey:@"birthprovince"];
//    
//    [g_userSettingInfo setUserPersonalInfo:settingPersonalInfo];

    // 到相应省的城市列表
    SettingHomeCityViewController *homeCity = [[SettingHomeCityViewController alloc] init];
    
    NSArray *cities = [[provinces objectAtIndex:row] objectForKey:@"cities"];
    homeCity.cities = cities;
    homeCity.birthProvince = provincesStr;
    homeCity.fromName = _fromName;
    [self.navigationController pushViewController:homeCity animated:YES];
}
