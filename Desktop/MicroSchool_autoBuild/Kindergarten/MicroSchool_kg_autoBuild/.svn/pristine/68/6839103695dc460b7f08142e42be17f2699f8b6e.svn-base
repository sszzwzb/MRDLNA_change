...
#import "MeWorkViewController.h"

@interface MeWorkViewController ()

@end

@implementation MeWorkViewController
...
{
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(reflashHomeworkView:) name:@"Weixiao_deleteMyHomeWork" object:nil];
    ...
    [ReportObject event:ID_OPEN_MY_HOMEWORK];//2015.06.24
}

-(void)viewWillDisappear:(BOOL)animated
{
    [[NSNotificationCenter defaultCenter] removeObserver:self name:@"Weixiao_deleteMyHomeWork" object:nil];
}
...
//            [self performSelector:@selector(testFinishedLoadData) withObject:nil afterDelay:0.5];
            ...
            [ReportObject event:ID_DELETE_HOMEWORK];//2015.06.24
        }
        else
        {
