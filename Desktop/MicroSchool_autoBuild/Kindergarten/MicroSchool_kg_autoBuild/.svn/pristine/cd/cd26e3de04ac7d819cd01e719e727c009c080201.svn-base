...
#import "NewsCommentViewController2.h"
#import "FriendProfileViewController.h"

@interface NewsCommentViewController2 ()

@end

@implementation NewsCommentViewController2

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    
    [super setCustomizeTitle:@"回复"];
    ...
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, 320, [UIScreen mainScreen].applicationFrame.size.height - 44 - 44) style:UITableViewStylePlain];
...
- (void)doGetCommentData:(NSDictionary *)param
{
    [[TSNetworking sharedClient] requestWithBaseURLAndParams:param successBlock:^(TSNetworking *request, id responseObject) {
        ...
        if(true == [result intValue]) {
            ...
            ((UILabel *)self.navigationItem.titleView).text = [NSString stringWithFormat:@"回复 (%@)", [dic objectForKey:@"count"]];
            ...
            if ([_commentDataArr count] > 0) {
                ...
                noDataView = [Utilities showNodataView:@"暂无回复" msg2:@"" andRect:rect];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.btn_thumb.frame = CGRectMake(20, 10, 40, 40);
        ...
        if (buttonIndex == 1) {
            ...
            [[TSNetworking sharedClient] requestWithBaseURLAndParams:data successBlock:^(TSNetworking *request, id responseObject) {
                ...
                if(true == [result intValue]) {
                    ...
                    ((UILabel *)self.navigationItem.titleView).text = [NSString stringWithFormat:@"回复 (%@)", [NSString stringWithFormat:@"%lu",(unsigned long)[_commentDataArr count]]];
...
-(void)AudioClick:(id)sender
{
    ...
    if ([@""  isEqual: _inputTextView.text]) {
        ...
        clickFlag = 0;
        [_inputTextView resignFirstResponder];
        toolBar.frame = CGRectMake(0, [UIScreen mainScreen].applicationFrame.size.height - 44 - 44, 320, 44);
        [keyboardButton setImage:[UIImage imageNamed:@"btn_bq_d.png"]
                        forState:UIControlStateNormal];
        [keyboardButton setImage:[UIImage imageNamed:@"btn_bq_p.png"]
                        forState:UIControlStateHighlighted];
