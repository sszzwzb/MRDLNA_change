//
//  MySubscribedArticlesViewController.m
//  MicroSchool
//
...
@interface MySubscribedArticlesViewController ()
@property (strong, nonatomic) IBOutlet UITableView *tableView;

@end

@implementation MySubscribedArticlesViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view from its nib.
    [self setCustomizeLeftButton];
    [self setCustomizeTitle:@"我订阅的文章"];
    ...
    [ReportObject event:ID_OPEN_SUBSCRIBE_ARTICLE];//2015.06.24
...
-(void)loadData:(NSString*)index{
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        NSMutableArray *array = [FRNetPoolUtils getMySubscribedArticles:index size:@"20"];
            ...
            if (array == nil) {
                ...
                if ([array count] >0) {
                    ...
                    if ([startNum intValue] > 0) {
                        ...
                        //我订阅的文章最新一条的id 倒序
                        NSString *lastIdStr = [[listArray objectAtIndex:0] objectForKey:@"kid"];
                        NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
                        [userDefaults setObject:lastIdStr forKey:@"lastKid"];
