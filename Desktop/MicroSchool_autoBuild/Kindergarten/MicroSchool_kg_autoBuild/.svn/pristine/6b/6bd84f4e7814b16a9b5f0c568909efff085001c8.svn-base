...
//    [self.navigationController setNavigationBarHidden:NO animated:NO];    2017.10.11  注掉
...
//                        noDataView = [Utilities showNodataView:@"无图无真相 TOT" msg2:@"" andRect:rect imgName:@"noPhotoBg.png" textColor:[UIColor grayColor] startY:250.0+64.0];
            ...
            if ([dataArray count] > 0 || [albumDic count] >0) {
...
//            [Utilities showAlert:@"错误" message:[respDic objectForKey:@"message"] cancelButtonTitle:@"确定" otherButtonTitle:nil];
            
            UIAlertView *alertV = [[UIAlertView alloc] initWithTitle:@"错误" message:[respDic objectForKey:@"message"] delegate:self cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
            [alertV show];
