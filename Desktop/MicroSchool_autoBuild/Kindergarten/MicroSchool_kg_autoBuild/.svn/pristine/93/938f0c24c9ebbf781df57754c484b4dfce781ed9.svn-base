...
@interface GroupChatDetailViewController : BaseViewController<UITableViewDelegate, UITableViewDataSource, UIGestureRecognizerDelegate, HPGrowingTextViewDelegate, UINavigationControllerDelegate,  UIImagePickerControllerDelegate, UIActionSheetDelegate, UIAlertViewDelegate,FaceBoardDelegate,RecordAudioDelegate>{
    //聊天目标
    //UserObject *user;
    //聊天详细列表
    ...
    // 要重发的消息
    GroupChatDetailObject *resendMsg;
...
// 要重发的消息
@property (nonatomic, retain) GroupChatDetailObject *resendMsg;
...
@property(nonatomic, retain) GroupChatList *groupChatList;
...
// 标识cell是否被描画过的array
//@property (nonatomic, retain) NSMutableArray *chatReflashArray;
