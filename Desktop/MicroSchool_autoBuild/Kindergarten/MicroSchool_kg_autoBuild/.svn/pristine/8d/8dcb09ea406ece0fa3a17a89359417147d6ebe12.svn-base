...
@interface MySubjectsViewController ()
@property (strong, nonatomic) IBOutlet UITableView *tableView;

@end

@implementation MySubjectsViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view from its nib.
    [self setCustomizeLeftButton];
    [self setCustomizeTitle:@"我的课程"];
    ...
    [ReportObject event:ID_OPEN_MY_COURSE];// 2015.06.24
...
-(void)loadData:(NSString*)index{
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        NSMutableArray *array = [FRNetPoolUtils getMySubjects:index size:@"20"];
                ...
                if ([array count] >0) {
                    ...
                    [self performSelectorOnMainThread:@selector(reload) withObject:nil waitUntilDone:YES];
                     ...
                     if ([listArray count] == 0) {
                        ...
                        noDataView = [Utilities showNodataView:@"暂未发布任何知识点" msg2:@""];
...
- (void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    knowledgeDetailViewCtrl.subuid = @"1";
