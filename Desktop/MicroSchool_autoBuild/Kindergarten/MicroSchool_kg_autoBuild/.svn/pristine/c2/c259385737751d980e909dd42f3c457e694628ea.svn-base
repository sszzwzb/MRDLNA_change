...
#import "PostWorkViewController.h"

@interface PostWorkViewController ()

@end

@implementation PostWorkViewController
...
//    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(reflashHomeworkView:) name:@"Weixiao_reflashHomeworkView" object:nil];
    ...
    [ReportObject event:ID_OPEN_MY_REPLY_HOMEWORK];//2015.06.24
}
