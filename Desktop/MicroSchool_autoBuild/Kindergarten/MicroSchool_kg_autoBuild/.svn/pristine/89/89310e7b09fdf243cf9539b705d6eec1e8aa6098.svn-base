...
{    
    ...
    UIView *bottomLine = [[UIView alloc] initWithFrame:CGRectMake(_weekDayView.frame.origin.x, _weekDayView.frame.size.height, _weekDayView.frame.size.width, 0.5)];
    bottomLine.backgroundColor = [UIColor lightGrayColor];
    
    [_weekDayView addSubview:bottomLine];
}
