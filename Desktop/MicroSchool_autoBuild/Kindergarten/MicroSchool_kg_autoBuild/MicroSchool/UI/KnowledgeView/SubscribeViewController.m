...
//    NSUInteger section = [indexPath section];
    ...
    cell.button_collect.hidden = YES;
...
- (void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //NSDictionary *dic = [NSDictionary dictionaryWithObject:@"subView" forKey:@"tid"];
...
-(void)createHeaderView
{
    ...
    [network sendHttpReq:HttpReq_WikiFollowingWiki andData:data];
}
