...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        label_title = [[UILabel alloc] initWithFrame:CGRectMake(
                                                                ...
                                                                imgView_head.frame.origin.y - 10,
                                                                WIDTH - 75 - 35 - 30,
                                                                35)];
        ...
        [button_collect setBackgroundImage:[UIImage imageNamed:@"knowledge/btn_common_r_d.png"] forState:UIControlStateNormal] ;
        [button_collect setBackgroundImage:[UIImage imageNamed:@"knowledge/btn_common_r_p.png"] forState:UIControlStateHighlighted] ;
