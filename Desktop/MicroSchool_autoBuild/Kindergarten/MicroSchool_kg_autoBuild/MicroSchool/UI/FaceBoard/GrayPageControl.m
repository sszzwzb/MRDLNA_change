...
- (id)initWithCoder:(NSCoder *)aDecoder {
    ...
    if ( self ) {
        ...
        activeImage = [[UIImage imageNamed:@"faceImages/faceBoard/inactive_page_image.png"] retain];
        inactiveImage = [[UIImage imageNamed:@"faceImages/faceBoard/active_page_image.png"] retain];
