...
@interface ScoreDetailViewController : BaseViewController<UITableViewDataSource,UITableViewDelegate,MomentsCommentsCellDelegate,FaceBoardDelegate,UITextViewDelegate,UIGestureRecognizerDelegate>{
...
@property(nonatomic,strong)NSString *examId;//考试id
@property(nonatomic,strong)NSString *cId;//考试id
@property(nonatomic,strong)NSDictionary *examDic;//成绩详情
