...
-(void)doShowContent{
    ...
    [coverImgV setClipsToBounds:YES];
    ...
    UIButton *delCollectionBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    delCollectionBtn.titleLabel.font = [UIFont systemFontOfSize:16.0];
    [delCollectionBtn setTitleColor:[UIColor colorWithRed:234.0/255.0 green:82.0/255.0 blue:85.0/255.0 alpha:1] forState:UIControlStateNormal];
     [delCollectionBtn setTitleColor:[UIColor colorWithRed:234.0/255.0 green:82.0/255.0 blue:85.0/255.0 alpha:1] forState:UIControlStateHighlighted];
    [delCollectionBtn setTitle:@"删除相册" forState:UIControlStateNormal];
    [delCollectionBtn setTitle:@"删除相册" forState:UIControlStateHighlighted];
    [delCollectionBtn setBackgroundImage:[UIImage imageNamed:@"delCollection_normal.png"] forState:UIControlStateNormal];
    [delCollectionBtn setBackgroundImage:[UIImage imageNamed:@"delCollection_press.png"] forState:UIControlStateHighlighted];
    [delCollectionBtn addTarget:self action:@selector(deleteCollection) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:delCollectionBtn];
    
    [delCollectionBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        
        make.top.equalTo(imgView_line4.mas_bottom).with.offset(20);
        make.left.equalTo(imgView_line4).with.offset(0);
        make.size.mas_equalTo(CGSizeMake([UIScreen mainScreen].bounds.size.width,45.0));
...
-(void)deleteCollection{
    ...
    UIAlertView *alertV = [[UIAlertView alloc] initWithTitle:@"删除相册" message:@"本相册和照片删除后无法恢复" delegate:self cancelButtonTitle:@"取消" otherButtonTitles:@"确定", nil];
...
-(void)deleteReal{
     ...
     * @date 2016.04.19
     * @args
     *  v=3 ac=Kindergarten op=delClassAlbum sid= cid= uid= app= aid=相册ID
     */
