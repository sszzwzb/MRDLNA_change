...
@interface NewsCommentViewController : BaseViewController<UITableViewDelegate, UITableViewDataSource, EGORefreshTableDelegate, UITextViewDelegate,FaceBoardDelegate,UIGestureRecognizerDelegate>
{
