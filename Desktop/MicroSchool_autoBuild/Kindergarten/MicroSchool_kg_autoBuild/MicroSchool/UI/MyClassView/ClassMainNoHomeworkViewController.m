//
//  ClassMainNoHomeworkViewController.m
//  MicroSchool
//
//  Created by kate on 6/12/14.
...
@interface ClassMainNoHomeworkViewController ()
...
@implementation ClassMainNoHomeworkViewController
...
- (void)viewDidLoad
{
    ...
    //[self performSelectorInBackground:@selector(getMyclassInfo) withObject:nil];
    [self getMyclassInfo];
...
/*-(void)selectRightAction:(id)sender
{
    ...
    if (!isRightButtonClicked) {
        ...
        buttonImg_d = [Utilities imageByScalingToSize:tagSize andImg:[UIImage imageNamed:@"icon_bjzl_d.png"]];
        buttonImg_p = [Utilities imageByScalingToSize:tagSize andImg:[UIImage imageNamed:@"icon_bjzl_p.png"]];
        ...
        buttonImg_d = [Utilities imageByScalingToSize:tagSize andImg:[UIImage imageNamed:@"icon_glcy_d.png"]];
        buttonImg_p = [Utilities imageByScalingToSize:tagSize andImg:[UIImage imageNamed:@"icon_glcy_p.png"]];
        ...
        [button_setAdmin setTitleEdgeInsets:UIEdgeInsetsMake(0, 10, 0, 0)];
        ...
        button_setAdmin.titleLabel.font = [UIFont boldSystemFontOfSize:13.0f];
        ...
        buttonImg_d = [Utilities imageByScalingToSize:tagSize andImg:[UIImage imageNamed:@"icon_tcbj_d.png"]];
        buttonImg_p = [Utilities imageByScalingToSize:tagSize andImg:[UIImage imageNamed:@"icon_tcbj_p.png"]];
...
-(void)checkNewInfo{
   ...
   // [self performSelectorInBackground:@selector(checkPublic:) withObject:@"班级公告"];
