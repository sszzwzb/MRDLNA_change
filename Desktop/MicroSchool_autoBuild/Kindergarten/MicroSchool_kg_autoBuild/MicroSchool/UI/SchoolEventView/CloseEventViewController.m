...
#import "CloseEventViewController.h"

@interface CloseEventViewController ()

@end

@implementation CloseEventViewController
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    // 查看已结束的活动列表
    [ReportObject event:ID_OPEN_OUT_EVENT];// 2015.06.13
}
